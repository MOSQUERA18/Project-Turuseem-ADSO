      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 content-center w-full">
        ...
        >
          ...
          <div className="flex justify-around">
            ...
            />
            {/* <button type="submit" className="bg-green-600 w-full py-3 px-8 rounded-xl text-white mt-2 uppercase font-bold hover:cursor-pointer hover:bg-green-700 md:w-auto">{buttonForm}<BsSend/></button> */}
