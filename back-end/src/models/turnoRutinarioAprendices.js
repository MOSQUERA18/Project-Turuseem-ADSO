...
const TurnoRutinarioAprendizModel = db.define("turnosrutinarios_aprendices",{
    Id_TurnoRutinarioAprendiz : {type:DataTypes.INTEGER,primaryKey:true,autoIncrement:true},
    Id_TurnoRutinario:{type:DataTypes.INTEGER,
        references:{
