    ...
    <Page size="A4">
      <View style={styles.section}>
        <View>
          ...
          <Text style={styles.textoPequeño}>
            Procedimiento: Seleccion, Desarrollo y Evaluacion de Desempeño de
            Personal{" "}
          </Text>
        </View>
      ...
      <View>
        ...
        <Text style={styles.texto1}>
          Me permito notificarle que por su inasistencia a turno rutinario se
          gemera el respectivo Memorando.
        </Text>
        <Text style={styles.texto1}>
          Igual lo invitamos a continuar con el cumplimiento de sus labores que
          contribuyen con el buen funcionamiento de la estrategia Sena Empresa.
          Recuerde que usted es parte fundamental de los procesos productivos de
          las unidades tanto en lo técnico como en lo administrativo.
        </Text>
        <Text style={styles.texto1}>
          Este es em memorando numero 2 del trimestre ll {`${año}`}
        </Text>
        <Text style={styles.texto1}>
          Nota: Este correctivo se realizará de acuerdo con la normatividad
          vigente del Sena se archiva en la hoja de vida del aprendiz y sirve
          como evidencia para el comité de evaluación. Tiene cuarenta y ocho
          horas (48) a partir del momento en que se le entrega el memorando para
          justificarlo en forma escrita o a través de correo.
        </Text>
