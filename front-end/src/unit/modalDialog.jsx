          ...
          >
                    ...
                    <div className="mt-2 flex flex-col items-center">
                      <p className="text-base text-gray-500 m-0.5">
                        ...
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Id_Unidad}
                        </span>
                      </p>
                      <p className="text-base text-gray-500 m-0.5">
                        Nombre:{" "}
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Nom_Unidad}
                        </span>
                      </p>
                      <p className="text-base text-gray-500 m-0.5">
                        Hora Apertura:{" "}
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Hor_Apertura}
                        </span>
                      </p>
                      <p className="text-base text-gray-500 m-0.5">
                        Hora Cierre:{" "}
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Hor_Cierre}
                        </span>
                      </p>
                      <p className="text-base text-gray-500 m-0.5">
                        Estado:{" "}
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Estado}
                        </span>
                      </p>
                      <p className="text-base text-gray-500 m-0.5">
                        Área Perteneciente:{" "}
                        <span className="font-bold mx-2">
                          {onDoubleClickUnit.Id_Area}
                        </span>
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                ...
                data-autofocus
                onClick={() => [
                  deleteUnit(onDoubleClickUnit.Id_Unidad),
                  setOpen(false),
                ]}
              ...
              <button
                ...
                data-autofocus
                onClick={() => [
                  getUnit(onDoubleClickUnit.Id_Unidad),
                  setOpen(false),
                  setModalDialog(false),
                  setStateAddUnit(true),
                ]}
